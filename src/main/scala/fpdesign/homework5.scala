...
object homework5 extends App {
  ...
  trait Applicative[F[_]] extends Functor[F] {
    ...
    def map3[A, B, C, D](fa: F[A], fb: F[B], fc: F[C])(f: (A, B, C) => D): F[D] = {
      ...
      val bcd: F[B => C => D] = ap(fabcd)(fa)
      val cd: F[C => D] = ap(bcd)(fb)
      ap(cd)(fc)
    }

    def map4[A, B, C, D, E](fa: F[A], fb: F[B], fc: F[C], fd: F[D])(f: (A, B, C, D) => E): F[E] = ap(ap(ap(ap(pure(f.curried))(fa))(fb))(fc))(fd)
